<?php
  ...
  $edit = mysqli_query(
    ...
    SET Nama_Makanan='$Nama_Makanan', Desk_Makanan='$Desk_Makanan', Harga_Makanan='$Harga_Makanan', Img_Makanan='$Img_Makanan'
    WHERE Nama_Makanan='$Nama_Makanan'") or die (mysqli_error($koneksi));
?>